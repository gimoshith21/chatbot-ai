...
def ask_chatbot(query, chat_history=None):
    ...
    # Build system prompt
    system_prompt = (
        f"You are GIMO's personal AI assistant. "
        f"Your job is to help users learn about GIMO's background, "
        ...
        f"Use the provided excerpts as your primary source of truth for factual information about GIMO. "
        ...
        f"Answer in third person when talking about GIMO, but you may use natural conversational language "
